...
# -*- coding: utf-8 -*-
#
# CNVfinder documentation build configuration file, created by
...
def setup(app):
    app.add_stylesheet('css/cnvfinder.css')
...
htmlhelp_basename = 'CNVfinderdoc'
...
man_pages = [
    (master_doc, 'cnvfinder', 'CNVfinder Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CNVfinder', 'CNVfinder Documentation',
     author, 'CNVfinder', 'One line description of project.',
     'Miscellaneous'),
]
